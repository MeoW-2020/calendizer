...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private int createEvent(SQLiteDatabase sqLiteDatabase, Event event) {
        ...
        contentValues.put(DBTables.EVENT_IS_BIRTHDAY, event.isBirthday() ? TRUE : FALSE);
        contentValues.put(DBTables.EVENT_IS_DONE, event.isDone() ? TRUE : FALSE);
        ...
        contentValues.put(DBTables.EVENT_ADDRESS, event.getAddress());
        contentValues.put(DBTables.EVENT_PHONE_NUMBER, event.getPhoneNumber());
        contentValues.put(DBTables.EVENT_EMAIL, event.getEmail());
    ...
    private int createEventParent(SQLiteDatabase sqLiteDatabase, Event event) {
        ...
        contentValues.put(DBTables.EVENT_INSTANCE_EXCEPTION_EVENT_IS_BIRTHDAY, event.isBirthday() ? TRUE : FALSE);
        contentValues.put(DBTables.EVENT_INSTANCE_EXCEPTION_EVENT_IS_DONE, event.isDone() ? TRUE : FALSE);
        ...
        contentValues.put(DBTables.EVENT_INSTANCE_EXCEPTION_EVENT_EVENT_ADDRESS, event.getAddress());
        contentValues.put(DBTables.EVENT_INSTANCE_EXCEPTION_EVENT_EVENT_PHONE_NUMBER, event.getPhoneNumber());
        contentValues.put(DBTables.EVENT_INSTANCE_EXCEPTION_EVENT_EVENT_EMAIL, event.getEmail());
    ...
    public Event readEvent(SQLiteDatabase sqLiteDatabase, int eventId) {
        ...
        while (cursor.moveToNext()) {
            ...
            event.setBirthday(cursor.getInt(cursor.getColumnIndex(DBTables.EVENT_IS_BIRTHDAY)) == TRUE);
            event.setDone(cursor.getInt(cursor.getColumnIndex(DBTables.EVENT_IS_DONE)) == TRUE);
            ...
            event.setAddress(cursor.getString(cursor.getColumnIndex(DBTables.EVENT_ADDRESS)));
            event.setPhoneNumber(cursor.getString(cursor.getColumnIndex(DBTables.EVENT_PHONE_NUMBER)));
            event.setEmail(cursor.getString(cursor.getColumnIndex(DBTables.EVENT_EMAIL)));
        }
        return event;
    }
    ...
    private Cursor readEventInstanceExceptionByEventId(SQLiteDatabase sqLiteDatabase, int eventId) {
        String[] projection = {
                ...
                DBTables.EVENT_INSTANCE_EXCEPTION_EVENT_IS_BIRTHDAY,
                DBTables.EVENT_INSTANCE_EXCEPTION_EVENT_IS_DONE,
                ...
                DBTables.EVENT_INSTANCE_EXCEPTION_EVENT_EVENT_ADDRESS,
                DBTables.EVENT_INSTANCE_EXCEPTION_EVENT_EVENT_PHONE_NUMBER,
                DBTables.EVENT_INSTANCE_EXCEPTION_EVENT_EVENT_EMAIL};
    ...
    private Cursor readEventById(SQLiteDatabase sqLiteDatabase, int eventId) {
        String[] projection = {
                ...
                DBTables.EVENT_IS_BIRTHDAY,
                DBTables.EVENT_IS_DONE,
                DBTables.EVENT_DATE,
                ...
                DBTables.EVENT_ADDRESS,
                DBTables.EVENT_PHONE_NUMBER,
                DBTables.EVENT_EMAIL,
